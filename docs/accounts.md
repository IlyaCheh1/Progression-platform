...
Source: `Мастер Меча.xlsx (production-style local accounts)` hash `389345302d95` as-of `2026-07-19` sheet `июль`

Initial passwords — change after first login in production.

| Name | Role | Login | Password |
|---|---|---|---|
| Макс Киселев | administrator, coach | `maks-kiselev@mastersword.ru` | `maks123` |
...
| Татьяна Грибанова | administrator, coach | `tatyana-gribanova@mastersword.ru` | `tatyana123` |
| Николай Лобаев | student, coach | `nikolay-lobaev@mastersword.ru` | `nikolay123` |
