<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
    ...
    <defs>
      ...
      >
        <stop :stop-color="logoGradients[0]" />
        <stop offset="0.52399" :stop-color="logoGradients[1]" />
        <stop offset="1" :stop-color="logoGradients[2]" />
      </linearGradient>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop :stop-color="logoGradients[3]" />
        <stop offset="0.52399" :stop-color="logoGradients[4]" />
        <stop offset="1" :stop-color="logoGradients[5]" />
      </linearGradient>
    </defs>
  </svg>
</template>
...
withDefaults(
  ...
  {
    logoGradients: () =>
      ['#881AFF', '#5E16D9', '#3B0C8A', '#881AFF', '#5E16D9', '#3B0C8A'] as [
        string,
        string,
        string,
        string,
