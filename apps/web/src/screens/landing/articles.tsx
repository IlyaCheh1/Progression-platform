      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        <div className="reveal-fade mb-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm text-white/45">
            Заметки о фехтовании и истории, выдержки из трактатов, гайды и инструкции и еще много полезных и интересных материалов из мира исторического фехтования и восточных единоборств
          </p>
        </div>
