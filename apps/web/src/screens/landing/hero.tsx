    ...
    <section id="hero" className="kids-hero relative h-dvh min-h-[32rem] w-full overflow-hidden" style={{ background: "var(--void)" }}>
      ...
      <div className="hero-main relative z-10 flex h-full flex-col items-center px-6 text-center">
        ...
        <div className="flex w-full flex-1 flex-col items-center justify-center">
          <div className="kids-hero-join">
            <h1
              className="kids-hero-intro mobile-fluid-hero-title flex max-w-4xl flex-col items-center font-unbounded font-medium tracking-tight"
        ...
        <div className="flex w-full max-w-xl flex-col items-center gap-2 pb-6 text-center">
