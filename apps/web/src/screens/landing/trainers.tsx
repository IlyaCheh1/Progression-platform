...
const KIDS_TRAINER_ID = "tatyana-gribanova";

export default function Trainers() {
  const sectionRef = useRef<HTMLElement>(null);
  const source = LANDING_TRAINERS.find((trainer) => trainer.id === KIDS_TRAINER_ID);
  useRevealFade(sectionRef, 0.12);
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <article
            ...
            style={{ ["--trainer-accent" as string]: trainer.accent }}
          >
