...
export default function ProfileHeader({
  ...
  return (
    <header className="witcher-header relative z-40 w-full shrink-0">
      <div className="flex h-14 w-full items-stretch gap-2 px-3 xl:h-[72px] xl:gap-4 xl:px-5">
        <Link
          href="/"
        ...
        >
          <AppLogo size={28} className="xl:hidden" />
          <AppLogo size={36} className="hidden xl:block" />
        </Link>
