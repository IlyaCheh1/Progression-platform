  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col gap-2">
        ...
        <div className="flex w-full flex-col gap-1.5 xl:gap-4">
          {tasks.map((task) => (
...
function TaskRow({ task }: { task: Quest }) {
  ...
  return (
    <div className="flex w-full flex-col gap-1 transition-opacity duration-200 hover:opacity-80">
      <div className="flex w-full items-start justify-between gap-2 text-[8px] leading-3 xl:text-xs xl:leading-4">
      ...
      <div className="flex w-full items-center justify-between">
        ...
        <div className="ml-2 flex items-center gap-1 text-[8px] font-medium leading-3 text-mos-text xl:text-xs xl:leading-4">
          <span>{current}</span>
          <span>/</span>
          <span>{target}</span>
        </div>
