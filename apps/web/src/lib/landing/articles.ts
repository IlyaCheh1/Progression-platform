...
export const JOURNAL_ARTICLES: JournalArticle[] = [
  ...
  },
  {
    ...
    title: "Детская секция ушу: сила тела, дух дракона",
    teaser:
      "Мы формируем характер, волю и уверенность — и растим чемпионов. Набор от 6 лет, первое занятие бесплатно. Тренер Татьяна: 10 лет преподавания, 25 лет в спорте.",
    cover: "/media/courses/east-hero.webp",
    date: "2026-08-28",
    mock: true,
  },
  {
